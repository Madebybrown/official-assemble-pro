...
export default function VideoMontage() {
  return (
    <div className="bg-gray-300 dark:bg-white col-span-3 sm:col-span-3 md:col-span-3 lg:col-span-2 row-span-2 sm:row-span-4 md:row-span-2 lg:row-span-2 shadow-lg rounded-sm rounded-xl">
