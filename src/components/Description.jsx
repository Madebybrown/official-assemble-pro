...
export default function Description() {
  return (
    <div className="hidden sm:block md:block lg:block col-span-3 sm:col-span-3 md:col-span-3 lg:col-span-2 row-span-1 sm:row-span-1 md:row-span-1 lg:row-span-1 my-auto">
